    ...
    >
      <form className="space-y-6" onSubmit={handleSubmit}>
        ...
        <div className="space-y-4">
          <Button type="submit" className="w-full px-5 py-3" disabled={isSubmitting || isGoogleSubmitting}>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full py-3 hover:bg-slate-50 border border-slate-200 text-slate-700 flex items-center justify-center gap-3 active:scale-95 transition-all"
          ...
          >
            ...
            {isGoogleSubmitting ? "Connecting Google..." : "Google"}
          </Button>
        </div>
      </form>
    </AuthShell>
