...
//   return (
//     <div className="relative w-full h-full flex items-center justify-center bg-[#F4F7FC] border border-blue-100/70 rounded-xl overflow-hidden group-hover:bg-blue-50/50 group-hover:border-blue-300 transition-all duration-500 shadow-inner">
//       {/* Light Blueprint Grid Backdrop */}
//       <div className="absolute inset-0 opacity-[0.08] pointer-events-none" style={{
//         backgroundImage: "radial-gradient(circle, #0F3D91 1px, transparent 1px), linear-gradient(to right, #0F3D91 1px, transparent 1px), linear-gradient(to bottom, #0F3D91 1px, transparent 1px)",
//         backgroundSize: "14px 14px, 28px 28px, 28px 28px",
//         backgroundPosition: "center"
//       }} />

//       {/* CAD technical metadata */}
//       <div className="absolute inset-x-4 top-3.5 flex justify-between text-[9px] font-mono text-blue-900/40 select-none uppercase tracking-widest font-semibold">
//         <span>UNIT: MM</span>
//         <span>SPDX-CAD V1.0</span>
//       </div>

//       <div className="absolute inset-x-4 bottom-3.5 flex justify-between text-[9px] font-mono text-blue-900/30 select-none">
//         <span>[{type.toUpperCase()}_SPEC_DRAWING]</span>
//         <span className="text-[#0F3D91]/60 font-bold">● REGISTERED</span>
//       </div>

//       {/* SVG Outline vectors */}
//       <svg
//         className="w-2/3 h-2/3 text-slate-400 group-hover:text-[#0F3D91] group-hover:drop-shadow-[0_0_10px_rgba(15,61,145,0.15)] transition-all duration-500 stroke-[1.25]"
//         viewBox="0 0 100 120"
//         fill="none"
//         stroke="currentColor"
//         strokeLinecap="round"
...
//   return (
//     <div className="group bg-white border border-slate-200/80 hover:border-blue-300 hover:shadow-[0_16px_36px_rgba(15,61,145,0.06)] rounded-2xl p-4 transition-all duration-300 flex flex-col justify-between">
//       {/* Aspect Ratio 3:4 Blueprint Box */}
//       <div className="aspect-[3/4] relative w-full mb-4 overflow-hidden rounded-xl">
//         <ApparelWireframe type={product.blueprintType} />
//       </div>

//       {/* Clean Showcase Labels & Specs */}
//       <div className="space-y-3.5">
//         <h3 className="text-sm font-bold text-slate-900 group-hover:text-[#0F3D91] transition-colors duration-200 tracking-tight line-clamp-1">
//           {product.name}
//         </h3>

//         {/* Technical Matrix Labeling */}
//         <div className="space-y-2 text-[10px] font-mono p-3 rounded-lg bg-[#FAFBFD] border border-slate-100">
//           <div className="flex justify-between border-b border-slate-200/60 pb-1.5">
//             <span className="text-slate-400 uppercase tracking-wider text-[9px]">SPECIFICATION:</span>
//             <span className="text-slate-800 font-semibold text-right truncate max-w-[120px]">{product.spec}</span>
//           </div>
//           <div className="flex justify-between pt-0.5">
//             <span className="text-slate-400 uppercase tracking-wider text-[9px]">FABRIC:</span>
//             <span className="text-blue-900 font-semibold text-right truncate max-w-[120px]">{product.fabric}</span>
//           </div>
//         </div>
//       </div>
//     </div>
